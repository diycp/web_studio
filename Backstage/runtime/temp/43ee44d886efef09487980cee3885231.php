<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\wamp64\www\Backstage\public/../application/admin\view\slide\index.html";i:1530098375;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="my-btn-box">
    <span class="fl">
        ...
        <a class="layui-btn btn-add btn-default" id="btn-add">发布公告</a>
...
<script type="text/javascript">
    ...
    layui.use(['table', 'form', 'layer', 'vip_table'], function () {
        ...
        var tableIns = table.render({
            ...
            cellMinWidth: 80,  
            id: 'notice',
            url: "<?php echo url('Notice/listNotice'); ?>",
            method: 'get',
            page: true,
        ...
        $('#btn-add').on('click', function () {
            layer.open({
                ...
                maxmin: true,
                area: ['40%', '50%'],
                content: "<?php echo url('Notice/addNotice'); ?>",
                end: function(){
                    tableIns.reload('notice', {});
                }
            });
        });
        ...
        $('#btn-delete-all').on('click',function(){
            var checkStatus = table.checkStatus('notice'); // table-id-2 即为基础参数id对应的值
            ...
            layer.confirm('真的批量删除用户？', function(index){
                    $.ajax({
                        type: 'post',
                        url: "<?php echo url('Notice/batchDel'); ?>",
                        data:{
                            'ids':ids
                        },
                        dataType: 'json',
        ...
        table.on('tool(table)', function(obj){
            ...
            if(layEvent == 'edit'){
                layer.open({
                    ...
                    maxmin: true,
                    area: ['40%', '50%'],
                    content:"<?php echo url('Notice/editNotice'); ?>?id="+data.id
                });
            }
            ...
            if(layEvent === 'del'){ 
                layer.confirm('真的删除该栏目？', function(index){
                    $.ajax({
                        type: 'get',
                        url: "<?php echo url('Notice/delNotice'); ?>?id="+data.id,
                        dataType: 'json',
                        success: function(data){
                            if(data.status == 0){
