<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp64\www\Backstage\public/../application/admin\view\category\addcategory.html";i:1530098700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<select name="pid"  lay-filter="aihao">
    ...
    <div class="layui-form-item">
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="desc" lay-verify="required" autocomplete="off" placeholder="请输入用户名" class="layui-input" maxlength="30">
        </div>
    </div>
    <div class="layui-form-item">
