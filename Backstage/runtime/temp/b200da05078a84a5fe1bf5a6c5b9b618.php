<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\wamp64\www\Backstage\public/../application/admin\view\content\addcontent.html";i:1530077906;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="">
    <input type="hidden" name="cid" lay-verify="required" value="<?php echo $cid; ?>" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" value="<?php echo $name; ?>" lay-verify="required" placeholder="发布者" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="sid" value="20" lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['form', 'layedit', 'laydate','upload','jquery'], function(){
        ...
        layedit.set({
            height: 700,
            uploadImage: {
                url: "<?php echo url('Uploads/editorUpload'); ?>", //接口url
                type: 'post' //默认post
            }
        });
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.ajax({
                type: 'post',
                url: "<?php echo url('Content/addContent'); ?>",
                data: {
                    cid: data.field.cid,
