<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\wamp64\www\Backstage\public/../application/admin\view\admin\addadmin.html";i:1530098921;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label"><span style="color: red;font-weight: bold;">*</span>是否启用</label>
        <div class="layui-input-block">
